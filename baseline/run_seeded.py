...
if __name__ == '__main__':
    ...
    # Journal benchmark addition: honor the explicit seed while leaving all
    # model/data/optimization settings unchanged from run.py.  The original
    # run.py remains untouched in this package.
    ...
    print(f"[Seeded baseline runner] random seed = {fix_seed}")
